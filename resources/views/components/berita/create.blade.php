<div class="modal fade text-left" id="create-berita" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-create-berita" id="form-create-berita" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn" id="close-create-berita" data-dismiss="modal">
